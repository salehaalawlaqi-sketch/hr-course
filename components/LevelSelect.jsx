...
const LEVEL_STYLES = {
  ...
  "hr-professional": "bg-orange-100 text-orange-800",
};
      ...
      <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
        {LEVELS.map((level) => (
          <button
            ...
            className="group cursor-pointer rounded-xl border border-border bg-card p-4 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-brand hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
          >
            <div className="flex items-center justify-between gap-2">
              ...
              <span
                className={`rounded-full px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide ${LEVEL_STYLES[level.id]}`}
              >
