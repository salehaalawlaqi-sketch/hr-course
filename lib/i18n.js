const STRINGS = {
  ...
  authShowPin: { en: "Show PIN", ar: "إظهار الرمز السري" },
  authHidePin: { en: "Hide PIN", ar: "إخفاء الرمز السري" },
  authTagline: {
    en: "Sign in to continue your HR training.",
    ar: "سجّل الدخول لمتابعة تدريبك في الموارد البشرية.",
  },
  signedInAs: { en: "Signed in as {name}", ar: "تم تسجيل الدخول باسم {name}" },
  welcomeBack: { en: "Welcome back, {name}!", ar: "مرحبًا بعودتك، {name}!" },
  scoreByCourse: { en: "Average score by course", ar: "متوسط النتيجة حسب المقرر" },
  passingChip: { en: "Passing (≥70%)", ar: "ناجح (٧٠٪ فأكثر)" },
  needsReviewChip: { en: "Needs review (<70%)", ar: "يحتاج مراجعة (أقل من ٧٠٪)" },
  logOut: { en: "Log Out", ar: "تسجيل الخروج" },
  hrDashboardNav: { en: "HR Dashboard", ar: "لوحة الموارد البشرية" },
  specialistAssessmentNav: { en: "Specialist Assessment", ar: "اختبار الأخصائي" },
  ...
  completedAriaLabel: { en: "Completed", ar: "مكتمل" },
  closeTutor: { en: "Close tutor", ar: "إغلاق المعلّم" },
  openTutor: { en: "Open AI HR Tutor", ar: "فتح المعلّم الذكي للموارد البشرية" },
  sendMessage: { en: "Send", ar: "إرسال" },
  tutorGenericError: { en: "Something went wrong.", ar: "حدث خطأ ما." },
  tutorStreamError: { en: "The tutor ran into a problem.", ar: "واجه المعلّم مشكلة." },
  tutorUnreachable: {
    en: "The tutor is unreachable right now. Please try again.",
    ar: "تعذّر الوصول إلى المعلّم حاليًا. يرجى المحاولة مرة أخرى.",
  },

  authError_invalid_credentials: { en: "Incorrect name or PIN.", ar: "الاسم أو الرمز السري غير صحيح." },
  authError_name_taken: {
    en: "That name is already taken. Try signing in instead.",
    ar: "هذا الاسم مُستخدم بالفعل. حاول تسجيل الدخول بدلاً من ذلك.",
  },
  authError_invalid_name: {
    en: "Please enter your name (2–60 characters).",
    ar: "يرجى إدخال اسمك (٢-٦٠ حرفًا).",
  },
  authError_invalid_pin: { en: "PIN must be 4–8 digits.", ar: "يجب أن يتكوّن الرمز السري من ٤ إلى ٨ أرقام." },
  authError_missing_fields: { en: "Enter your name and PIN.", ar: "أدخل اسمك والرمز السري." },
  authError_db_not_configured: {
    en: "The database isn't set up yet. Ask your administrator to configure it.",
    ar: "لم يتم إعداد قاعدة البيانات بعد. يرجى التواصل مع المسؤول لإعدادها.",
  },
  authError_server_error: { en: "Something went wrong. Please try again.", ar: "حدث خطأ ما. يرجى المحاولة مرة أخرى." },
  hrError_not_signed_in: { en: "Not signed in.", ar: "لم يتم تسجيل الدخول." },
  hrError_hr_only: { en: "HR access only.", ar: "هذا القسم مخصص لموظفي الموارد البشرية فقط." },
  hrError_server_error: { en: "Something went wrong. Please try again.", ar: "حدث خطأ ما. يرجى المحاولة مرة أخرى." },
};
