const STRINGS = {
  ...
  yourNameLabel: { en: "Your name (for certificates)", ar: "اسمك (لأجل الشهادات)" },
  yourNamePlaceholder: { en: "Enter your name", ar: "أدخل اسمك" },
  viewCertificate: { en: "View Certificate", ar: "عرض الشهادة" },

  learnerProfile: { en: "Learner Profile", ar: "ملف المتعلّم" },
  switchProfile: { en: "Switch profile", ar: "تبديل الملف الشخصي" },
  addProfile: { en: "+ Add learner", ar: "+ إضافة متعلم" },
  newProfileNamePlaceholder: { en: "New learner's name", ar: "اسم المتعلم الجديد" },
  addProfileConfirm: { en: "Add", ar: "إضافة" },
  cancel: { en: "Cancel", ar: "إلغاء" },
  teamActivity: { en: "Team Activity", ar: "نشاط الفريق" },
  teamActivitySubtitle: {
    en: "Everyone who has used this dashboard on this device.",
    ar: "كل من استخدم هذه اللوحة على هذا الجهاز.",
  },
